            ...
            <ul className="nav nav-pills flex-column mb-auto"> 
                <li className="nav-item" onClick={()=> setSelectedTab("Home")}> 
                 ...
                 <li className="nav-item" onClick={()=> setSelectedTab("Create Post")}> 
                    <a href="#" className={`nav-link ${ selectedTab==='Create Post' ? 'active' : 'link-body-emphasis'}`}> <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#speedometer2"></use></svg>    
                    Create Post</a> 
                </li> 
                <li className="nav-item" onClick={()=> setSelectedTab("Dashboard")}> 
                    <a href="#" className={`nav-link ${ selectedTab==='Dashboard' ? 'active' : 'link-body-emphasis'}`}> <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#speedometer2"></use></svg>    
                    Dashboard</a> 
                </li> 
                <li className="nav-item" onClick={()=> setSelectedTab("Orders")}> 
                    <a href="#" className={`nav-link ${ selectedTab==='Orders' ? 'active' : 'link-body-emphasis'}`}> <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#table"></use></svg>
                    Orders</a> 
                </li> 
                <li className="nav-item" onClick={()=> setSelectedTab("Products")}> 
                    <a href="#" className={`nav-link ${ selectedTab==='Products' ? 'active' : 'link-body-emphasis'}`}> <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#grid"></use></svg>
                    Products</a> 
                </li> 
                <li className="nav-item" onClick={()=> setSelectedTab("Customers")}> 
                    <a href="#" className={`nav-link ${ selectedTab==='Customers' ? 'active' : 'link-body-emphasis'}`}> 
